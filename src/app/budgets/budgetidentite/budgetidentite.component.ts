...
@Component({
  selector: 'app-budgetidentite',
  templateUrl: './budgetidentite.component.html',
  styleUrls: ['./budgetidentite.component.css']
})
export class BudgetidentiteComponent implements OnInit {
