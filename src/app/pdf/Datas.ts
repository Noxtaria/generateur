...
export class Datas implements HasHtmlFormat {
    ...
    htmlFormat() {
        ...
        <div class="row p-5">
            <div class="col-md-6">
                <img class="text-left" src="/src/logotype_signature_mail.png" alt="LOGO AUDACIOZA">
    ...
    <div class="row pb-5 p-5">
        <div class="col-sm-6 text-left">
            <p class="font-weight-bold">Agence Audacioza</p>
            <p class="mb-1">155 Rue Marcel Dassault Bâtiment B2</p>
            <p>59700 Marcq-en-Barœul</p>
            <p class="mb-1">Tél: 03.20.42.86.84</p>
        </div>
